...
let App = class {
  ...
  componentDidLoad() {
    ...
    {
      rIC( /*#__PURE__*/(0,C_Users_Antonio_Desktop_ProyectoEmpresas_ryg_frontend_ryg_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
        ...
        if (typeof window !== 'undefined') {
          Promise.resolve(/*! import() */).then(__webpack_require__.bind(__webpack_require__, /*! ./keyboard-808e4e15.js */ 26030)).then(module => module.startKeyboardAssist(window));
        }
...
let Footer = class {
  constructor(hostRef) {
    ...
    this.setupFadeFooter = /*#__PURE__*/function () {
      var _ref2 = (0,C_Users_Antonio_Desktop_ProyectoEmpresas_ryg_frontend_ryg_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (contentEl) {
        if (!contentEl) {
...
let Header = class {
  constructor(hostRef) {
    ...
    this.setupFadeHeader = /*#__PURE__*/function () {
      var _ref3 = (0,C_Users_Antonio_Desktop_ProyectoEmpresas_ryg_frontend_ryg_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (contentEl, condenseHeader) {
        if (!contentEl) {
